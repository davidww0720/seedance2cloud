...
🌐 **Homepage**: [https://seedance2.cloud](https://seedance2.cloud)
📋 **Pricing**: [https://seedance2.cloud/pricing](https://seedance2.cloud/pricing)
🎬 **Gallery**: [https://seedance2.cloud/gallery](https://seedance2.cloud/gallery)
...
- **Transparent credit pricing**: pay only for what you generate. [Free trial credits](https://seedance2.cloud/pricing) let you evaluate quality before committing.
...
1. Sign up at [seedance2.cloud](https://seedance2.cloud) — free trial credits included.
2. Pick a template from the [gallery](https://seedance2.cloud/gallery) or start from a prompt.
...
Full tutorials on the [homepage](https://seedance2.cloud).
...
This repository is the public-facing profile for [seedance2.cloud](https://seedance2.cloud). The platform itself runs on Cloudflare Workers + D1 + R2, with video generation via a multi-provider backend (KIE, FAL, APIMart, aivideoapi).

For partnership or technical inquiries: `hello@seedance2.cloud`.

## Resources

- **Main site**: https://seedance2.cloud
- **Pricing**: https://seedance2.cloud/pricing
- **Gallery** (examples): https://seedance2.cloud/gallery
- **Blog**: https://seedance2.cloud/blog
